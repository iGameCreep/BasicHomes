...
public class Constants {
    ...
    public static final String HOMES_MENU_NAME = SPECIAL_COLOR + "My Homes";
    ...
    public static final String DELETE_HOME_ITEM_NAME = WARNING_COLOR + "Delete this home";
    ...
    public static final Material DELETE_HOME_ITEM = Material.BARRIER;
